/**
 * Default Tailwind CSS theme object.
 *
 * This file contains the complete default theme configuration for Tailwind CSS,
 * serving as the canonical reference for theme resolution. It includes colors,
 * spacing, borderRadius, and other core theme properties.
 *
 * Based on Tailwind CSS v4 default theme with OKLCH colors.
 */
...
export const defaultTailwindTheme = {
  colors: {
    ...
    stone: {
      ...
      950: 'oklch(21.6% 0.006 56.043)', // Note: 950 is same as 900 in the provided @theme, but keeping as is
    },
    inherit: 'inherit',
  ...
  // Keep the existing spacing as it's more detailed
  spacing: {
    0: '0',
    0.5: '0.125rem',
    1: '0.25rem',
  ...
  // Add breakpoints, containers, etc. if needed
  screens: {
    sm: '40rem',
    md: '48rem',
    lg: '64rem',
