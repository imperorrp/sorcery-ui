...
/**
 * BorderWidthControl component - Smart container for border width properties.
 *
 * This component manages multiple variants of border width utilities and provides
 * a unified interface for controlling border thicknesses. It handles the complexity of mapping
 * between Tailwind variants and user-friendly side controls, supporting both linked
 * and unlinked modes.
 *
 * Key features:
 * - Manages border width variants: all sides, top, right, bottom, left
 ...
 *
 * The component acts as a smart wrapper around the presentational BorderWidthEditor,
 * handling all data logic and state management while providing clean props to the UI component.
 *
 * @component
 * @param {BorderWidthControlProps} props - Component props
 ...
 * @returns {JSX.Element} The rendered BorderWidthControl with BorderWidthEditor
 */
export const BorderWidthControl: React.FC<BorderWidthControlProps> = ({
   ...
   *
   * When switching to linked mode, sets all sides to the "all" value.
